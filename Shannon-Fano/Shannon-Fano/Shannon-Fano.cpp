...
void Bubble_Sort(ARRAY_TYPE_1* array, ARRAY_TYPE_2* array_2, int Array_Size);
...
void Shannon_Fano(unsigned* freq, char* sym, string& branch, string& fullBranch, int start, 
int end, RB_TREE_Node<char, string> *Symbols_Code, unsigned &Memory_Size_After);
